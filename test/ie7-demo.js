...
((/^ms/.test(document.documentElement.uniqueID)&&!/MSIE [89]/.test(navigator.appVersion))?"":"#ie7_demo button{display:none;}")+
"#ie7_demo{position:relative;background:"+
((/^ms/.test(document.documentElement.uniqueID)&&!/MSIE [89]/.test(navigator.appVersion)&&location.search!="?ie7_off")?"yellow":"#ccc")+
